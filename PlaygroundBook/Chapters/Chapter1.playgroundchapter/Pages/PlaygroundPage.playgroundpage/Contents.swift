 ...
 * callout(To get started:):
 Execute the code and point the camera to a plane. When it has found the plane, extinguish the 🔥 above it (by tapping anywhere on the screen) to heat the room up and start the game!
